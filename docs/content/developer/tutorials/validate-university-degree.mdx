...
src/
│   ├── issuer.rs      # Creates DID and issues credential
│   ├── holder.rs      # Accepts VC and creates signed VP
│   └── verifier.rs    # Validates the VP and VC
├── utils.rs          # Shared utilities for identity creation and storage
