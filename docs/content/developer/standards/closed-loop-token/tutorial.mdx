...
The `new_policy` function also returns a policy capability that grants admin rights, similar to the [treasury capability](../../../references/framework/iota/coin.mdx#struct-treasurycap).
