...
The [`Random`](../../references/framework/iota/random) API does not automatically prevent this kind of attack, and you must be aware of this subtlety when designing your contracts.
