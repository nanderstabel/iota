...
see [`iota::object_table::ObjectTable`](../../../../references/framework/iota/object_table.mdx#struct-objecttable).
...
see [`iota::object_bag::ObjectBag`](../../../../references/framework/iota/object_bag.mdx#struct-objectbag).
