...
The example also uses [`coin::into_balance`](../../../../references/framework/iota/coin.mdx#function-into_balance)
to wrap the fee's [`Coin`](../../../../references/framework/iota/coin.mdx) into a
[`Balance`](../../../../references/framework/iota/balance.mdx).
...
This flexibility can be achieved using [`Option`](../../../../references/framework/std/option.mdx).
...
If you call [`option::fill`](../../../../references/framework/std/option.mdx#function-fill) without checking and taking out the existing sword,
an error will occur.
...
Another approach is wrapping objects in a [`vector`](../../../../references/framework/std/vector.mdx),
