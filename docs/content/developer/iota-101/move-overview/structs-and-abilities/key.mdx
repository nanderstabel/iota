...
`key` ability, nor can any of the [Standard Library](../../../../references/framework/std/_category_.json) types.
The `key` ability is only present in the [IOTA Framework](../../../../references/framework/iota/_category_.json) and
custom types.
