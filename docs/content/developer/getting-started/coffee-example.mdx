...
- Basic understanding of blockchain concepts like [tokens](../../references/framework/iota/token.mdx) and [transactions](https://www.scalingparrots.com/en/what-is-a-blockchain-transaction/).
...
- [`iota::tx_context::sender`](../../references/framework/iota/tx_context.mdx): Manages the transaction context.
- [`iota::coin`](../../references/framework/iota/coin.mdx): Handles the creation and management of coins.
- [`iota::balance`](../../references/framework/iota/balance.mdx): Manages the balance of the shop.
- [`iota::token`](../../references/framework/iota/token.mdx): Manages the minting, transfer, and burning of tokens.
- [`iota::iota::IOTA`](../../references/framework/iota/iota.mdx): The IOTA cryptocurrency module.
...
The `transfer` function enables customers to [transfer](../../references/framework/iota/transfer.mdx) their `COFFEE` tokens to others, but with a 1-point fee deducted as commission. This demonstrates how Move can enforce rules and fees during token transfers, ensuring a fair system of exchange.
