...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/04_destroy_notarization.rs#L14-L25
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/04_destroy_notarization.rs#L34-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/04_destroy_notarization.rs#L41-L44
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/04_destroy_notarization.rs#L57-L66
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/04_destroy_notarization.rs#L64-L79
```
