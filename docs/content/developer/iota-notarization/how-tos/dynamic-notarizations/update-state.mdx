...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/05_update_state.rs#L17-L28
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/03_update_state.rs#L33-L36
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/05_update_state.rs#L55-L59
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/05_update_state.rs#L83
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/05_update_state.rs
```
