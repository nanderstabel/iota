...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/01_create_locked_notarization.rs#L26-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/01_create_locked_notarization.rs#L35-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/01_create_locked_notarization.rs
```
