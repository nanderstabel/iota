...
3. See: [Use IOTA Wallet with a Ledger Device](../about-iota/iota-wallet/how-to/import/ledger.mdx)

If you're using a **Ledger Nano S**, follow this [specific guide](../about-iota/iota-wallet/how-to/import/ledger.mdx).
...
1. Use **Firefly v2.1.0+** to extract the seed.
   - [Restore From Seed or Stronghold](../about-iota/iota-wallet/how-to/import/seed.mdx)
...
- Follow this guide to export the seed:  
  [Back up a Seed from a Firefly Profile](../about-iota/iota-wallet/how-to/import/seed.mdx)
...
3. Log out and export the seed:  
   [Guide to Exporting Seed](../about-iota/iota-wallet/how-to/import/seed.mdx)
