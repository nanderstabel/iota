...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/06_update_metadata.rs#L16-L28
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/06_update_metadata.rs#L34-L38
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/06_update_metadata.rs#L64-L67
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/06_update_metadata.rs#L56
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/06_update_metadata.rs
```
