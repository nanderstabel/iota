...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L19
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L29-L40
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L48-L50
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L55-L58
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L71-L97
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs#L107-L135
```
...
```rust reference
https://github.com/iotaledger/notarization/blob/d2f8af73d68b069085a6f13ecc9774d87a6e410f/examples/07_transfer_dynamic_notarization.rs
```
