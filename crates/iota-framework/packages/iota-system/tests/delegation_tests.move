...
module iota_system::stake_tests {
    ...
    fun test_add_preactive_remove_preactive_check_total_stake_amount() {
        ...
        assert_validator_candidate_total_stake_amounts(vector[NEW_VALIDATOR_ADDR], vector[100 * NANOS_PER_IOTA], scenario);
        ...
        assert_validator_candidate_total_stake_amounts(vector[NEW_VALIDATOR_ADDR], vector[0 * NANOS_PER_IOTA], scenario);
